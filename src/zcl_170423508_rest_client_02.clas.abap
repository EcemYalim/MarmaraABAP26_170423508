CLASS zcl_170423508_rest_client_02 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_170423508_rest_client_02 IMPLEMENTATION.
...
*    io_out->write( user_delete( ) ).
  ...
  METHOD user_create.
    ...
    rv_text = execute_request(
        iv_method = 'GET'
        iv_url = gc_base_url && '/user/demo_user'
    ).
    ENDMETHOD.
    ...
    rv_text = execute_request(
        iv_method = 'DELETE'
        iv_url = gc_base_url && '/user/user_demo'
    ).
    ENDMETHOD.

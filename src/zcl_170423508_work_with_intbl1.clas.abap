CLASS zcl_170423508_work_with_intbl1 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_170423508_work_with_intbl1 IMPLEMENTATION.
  ...
  connections = VALUE #( ( carrier_id = 'JL'
                         ...
                         ( carrier_id  = 'AA'
                           ...
                           airport_from_id = 'SFO'
                           airport_to_id = 'SIN'
                           carrier_name = 'Singapoer Airlines' ) ).
...
* Example2: LOOP WITH KEY ACCESS
************************************
  LOOP AT connections INTO connection
                      WHERE airport_from_id <> 'NIA'.

    out->write( data = connection
                name = |This is row number (sy-tabix): | ).
  ENDLOOP.

* Example3: MODIFY TABLE (key access)
***************************************

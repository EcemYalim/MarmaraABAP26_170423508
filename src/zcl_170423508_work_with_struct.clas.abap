CLASS zcl_170423508_work_with_struct DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_170423508_work_with_struct IMPLEMENTATION.
...
* Example1: Correspondence between FIELDS and INTO
***************************************************
...
* Example3: INTO CORRESPONDING FIELDS
***************************************************
...
* Example4: ALIAS NAMES FOR FIELDS
***************************************************
